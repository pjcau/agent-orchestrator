...
|----------|-------|-----------|
| Core | 149 | 4 attributes, 2 classs, 10 functions, 110 methods, 3 unknowns, 1 unreachable, 19 variables |
| Dashboard | 3 | 3 functions |
| Providers | 3 | 2 classs, 1 unreachable |
| Skills | 4 | 3 classs, 1 method |
