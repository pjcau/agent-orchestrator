...
| 7.8 | ⏳ Pending | Re-run weather-portal benchmark with the 6-verifier chain + revert guard | `docs/learning-path-tests/2026-05-XX_weather-portal-v2.md` | end-to-end |
