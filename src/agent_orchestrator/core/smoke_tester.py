...
LANGUAGE_SPECS: tuple[LanguageSpec, ...] = (
    LanguageSpec(
        ...
        entry_patterns=(
            ...
            "backend/main.py", "backend/app.py", "backend/__main__.py",
        ),
        binary="python3",
    ...
    LanguageSpec(
        ...
        entry_patterns=(
            "index.js", "src/index.js", "src/main.js", "server.js",
            "frontend/src/main.js", "frontend/index.js",
        ),
        binary="node",
        syntax_cmd=("node", "--check", "{entry}"),
    ),
    ...
    LanguageSpec(
        ...
        entry_patterns=(
            "src/main/java/Main.java", "src/main/java/App.java", "Main.java",
        ),
        binary="javac",
    ...
    LanguageSpec(
        ...
        config_files=(),
        entry_patterns=(
            "run.sh", "main.sh", "start.sh", "entrypoint.sh",
            "bin/run.sh", "scripts/run.sh",
        ),
        binary="bash",
