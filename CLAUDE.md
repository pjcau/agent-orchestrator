...
- **PR creation**: Automatic — when improvements are found, the script creates a branch `research-scout/YYYY-MM-DD-HHMM`, commits findings, pushes, and opens a PR. Works both locally and on CI.
