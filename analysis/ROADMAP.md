...
- [ ] **Phase 7.8** — Re-run the weather-portal benchmark with the 6-verifier chain + revert guard active; target: runtime 0 → ~20 (total ~68 / 100) AND the smoke tier should now catch any future static/runtime divergence by construction.
